const de = {
  ...
  settings: {
    ...
    mode: 'Antwortmodus',
    modeDesc: 'Passe den Stil der Antworten an deine Zielgruppe an.',
    modeNormal: 'Normal',
    modeNormalDesc: 'Ausgewogene Antworten für allgemeine Nutzer.',
    modeStudent: 'Student',
    modeStudentDesc: 'Didaktische Erklärungen, vollständige Gesetzesübersicht, Prüfungsaufbau.',
    modeLawyer: 'Anwalt',
    modeLawyerDesc: 'Technische Fachsprache, prozessuale Tiefe, setzt Volljurist-Niveau voraus.',
  },
  common: {
    loading: 'Laden...',
